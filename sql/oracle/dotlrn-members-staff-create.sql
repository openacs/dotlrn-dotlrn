...
begin
	...
	foo := acs_sc_impl.new (
		...
		impl_owner_name => 'dotlrn_members_staff'
	);
    ...
    foo := acs_sc_impl.new_alias (
        ...
        impl_alias => 'dotlrn_members_staff::add_portlet',
        impl_pl => 'TCL'
    );
    ...
    foo := acs_sc_impl.new_alias (
        ...
        impl_alias => 'dotlrn_members_staff::remove_portlet',
        impl_pl => 'TCL'
    );
    ...
    foo := acs_sc_impl.new_alias (
        ...
        impl_alias => 'dotlrn_members_staff::clone',
        impl_pl => 'TCL'
    );
